...
// Data Jurusan diurutkan dalam array untuk navigasi (Data ini tidak berubah)
...
export async function generateStaticParams() {
    return allJurusanArray.map((jurusan) => ({
        slug: jurusan.slug,
    }));
}
...
const JurusanDetailPage = ({ params }: JurusanPageProps) => {
    const { slug } = params;
    ...
    return (
        <main className="w-full">
            ...
            <section className="max-w-7xl mx-auto px-6 pt-16 pb-12">
                <Link
                    // Tautan Kembali ke Index Jurusan (Absolute Path)
                    href="/jurusan"
                ...
                <div className="grid md:grid-cols-3 gap-10 items-start">
                    {/* KONTEN GAMBAR DAN DESKRIPSI (KONTEN YANG HILANG) */}
                    ...
                    {/* AKHIR KONTEN GAMBAR DAN DESKRIPSI */}
                </div>
            </section>
