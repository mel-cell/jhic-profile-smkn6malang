...
Dengan fasilitas modern dan kurikulum yang adaptif, kami siap menjadi jembatan sukses bagi masa depan siswa dan mendukung pertumbuhan industri di Malang dan sekitarnya. Mari bergabung bersama kami.`;
  ...
  return (
    <section className="w-full bg-white py-16 md:py-20 px-4 md:px-0 pb-32 md:pb-40">
      <div className="w-full max-w-7xl pt-20 md:pt-30 mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-8 md:gap-10 items-center">
        ...
        >
          <div
            ...
            transform transition duration-300 hover:scale-110 md:hover:scale-120 hover:-translate-y-5 md:hover:-translate-y-10 hover:z-10 cursor-pointer"
          >
            <Image
              src={fotoUrl}
              ...
              width={600}
              height={600}
                className="w-full h-auto object-contain max-h-80 md:max-h-90 lg:max-h-96 shadow-lg rounded-md"
